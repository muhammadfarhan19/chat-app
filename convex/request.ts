...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (args.email === identity.email)
      throw new ConvexError("Can't send a request to your self");
    ...
    if (!receiver) throw new ConvexError("User couldn't be found");
...
export const deny = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!request || request.receiver !== currentUser._id)
      throw new ConvexError("There was n error denying this request");
...
export const accept = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!currentUser || request?.receiver !== currentUser._id)
